...
- Dashboard query/export helpers and REST dashboard CRUD now execute real SQL paths, but SPA-level smoke validation still needs to confirm the full UI flow against live backend endpoints.
