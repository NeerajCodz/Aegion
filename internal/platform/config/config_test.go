...
func TestLoad_ProductionConfigConformance(t *testing.T) {
	env := map[string]string{
		...
		"AEGION_MODULE_ADMIN_IMAGE":             "ghcr.io/aegion/aegion-admin:v1.0.0",
		"AEGION_MODULE_ADMIN_PUBLIC_URL":        "https://admin.example.com",
		"AEGION_MODULE_ADMIN_DATABASE_URL":      "postgres://admin:pass@localhost/admin?sslmode=require",
		"AEGION_MODULE_ADMIN_CA_CERT_FILE":      "/run/secrets/admin-ca.pem",
		"AEGION_MODULE_ADMIN_CLIENT_CERT_FILE":  "/run/secrets/admin-client.pem",
		"AEGION_MODULE_ADMIN_CLIENT_KEY_FILE":   "/run/secrets/admin-client-key.pem",
		"AEGION_MODULE_ADMIN_CREDENTIAL_FILE":   "/run/secrets/admin-credential",
		"AEGION_MODULE_OAUTH2_IMAGE":            "ghcr.io/aegion/aegion-oauth2:v1.0.0",
		"AEGION_MODULE_OAUTH2_PUBLIC_URL":       "https://oauth.example.com",
		"AEGION_MODULE_OAUTH2_DATABASE_URL":     "postgres://oauth:pass@localhost/oauth?sslmode=require",
		"AEGION_MODULE_OAUTH2_CA_CERT_FILE":     "/run/secrets/oauth-ca.pem",
		"AEGION_MODULE_OAUTH2_CLIENT_CERT_FILE": "/run/secrets/oauth-client.pem",
		"AEGION_MODULE_OAUTH2_CLIENT_KEY_FILE":  "/run/secrets/oauth-client-key.pem",
		"AEGION_MODULE_OAUTH2_CREDENTIAL_FILE":  "/run/secrets/oauth-credential",
		"AEGION_MODULE_PROXY_IMAGE":             "ghcr.io/aegion/aegion-proxy:v1.0.0",
		"AEGION_MODULE_PROXY_DATABASE_URL":      "postgres://proxy:pass@localhost/proxy?sslmode=require",
		"AEGION_MODULE_PROXY_CA_CERT_FILE":      "/run/secrets/proxy-ca.pem",
		"AEGION_MODULE_PROXY_CLIENT_CERT_FILE":  "/run/secrets/proxy-client.pem",
		"AEGION_MODULE_PROXY_CLIENT_KEY_FILE":   "/run/secrets/proxy-client-key.pem",
		"AEGION_MODULE_PROXY_CREDENTIAL_FILE":   "/run/secrets/proxy-credential",
